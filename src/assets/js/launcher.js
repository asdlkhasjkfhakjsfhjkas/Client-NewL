...
import skin from './panels/cuentaPanel.js';

class Launcher {
    async init() {
        this.initLog();
        console.log("Iniciando 2K Client...");
    ...
    initLog() {
        ...
        new logger('Manti Studio', '#7289da')
    }
        ...
        if (!accounts.length) {
            ...
            for (let account of accounts) {
                ...
                if (account.meta.type === 'Xbox') {
                    console.log(`Iniciando cuenta de XBOX ${account.name}...`);
                    ...
                    console.log(`ERROR MOJANG NO AUTORIZADO ${account.name}...`);
                    let refresh_accounts;
